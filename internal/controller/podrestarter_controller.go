...
import (
	...
	resiliencev1 "github.com/AshwinSarimin/pod-restarter-operator/api/v1"
)
...
func (r *PodRestarterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	podRestarter := &resiliencev1.PodRestarter{}
...
func (r *PodRestarterReconciler) restartPods(ctx context.Context, podRestarter *resiliencev1.PodRestarter, pods []corev1.Pod) (int, error) {
	log := log.FromContext(ctx)
	restarted := 0
...
func (r *PodRestarterReconciler) getInterval(podRestarter *resiliencev1.PodRestarter) time.Duration {
...
func (r *PodRestarterReconciler) setCondition(podRestarter *resiliencev1.PodRestarter, conditionType string, status metav1.ConditionStatus, reason, message string) {
